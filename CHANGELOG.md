...
### Fixed
- Re-release as v1.0.1 to supersede the stale v1.0.0 cached by HACS — contains all changes from v0.1.0 through v0.6.5
...
### Fixed
- More-info click area now limited to the battery icon only, not the entire card cell
